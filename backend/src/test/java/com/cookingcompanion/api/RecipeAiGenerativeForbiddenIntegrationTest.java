...
class RecipeAiGenerativeForbiddenIntegrationTest extends AbstractImportApiIntegrationTest {
    ...
    @Test
    void applyProfileWithUseGenerativeReturns403WhenFeatureDisabled() throws Exception {
        mockMvc.perform(
